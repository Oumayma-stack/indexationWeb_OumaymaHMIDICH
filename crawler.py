...
def save_results(results, filename="products.json"):
    """
    Saves the crawling results to a JSON file.
    
    Args:
        results (list): List of dictionaries containing crawled page data
        filename (str, optional): Name of the output file. Defaults to "products.json".
    """
...
def main():
    ...
    Crawls the target website and saves the results to a JSON file.
    """
